...
// Compila o PUG para gerar o HTML
function templates() {
...
// Compila SASS e CSS, minifica e adiciona instruções antigas ao CSS
function styles() {
...
// Roda o servidor BrowserSync para livepreview na porta 8000
function server() {
	browserSync.init({
		server: {
			baseDir: 'app/'
